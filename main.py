    ...
    def process_single_audit(self, audit: Dict[str, Any]):
        ...
        try:
            ...
            update_properties = {
                ...
                "GlockApps Seed List": {"rich_text": [{"text": {"content": ", ".join(seed_list) if seed_list else "Failed to retrieve"}}]},
            ...
            fallback_properties = {
                ...
                "GlockApps Seed List": {"rich_text": [{"text": {"content": "Fallback - GlockApps failed"}}]},
    ...
    def get_test_report(self, audit: Dict[str, Any]):
        ...
        try:
            ...
            if results.get("status") == "not_ready":
                logger.info(f"Test {test_id_field} waiting for stability, will check again in 15 seconds")
    ...
    try:
        while True:
            ...
            if audit_processed:
                ...
                time.sleep(60)  # Wait 1 minute for status updates
